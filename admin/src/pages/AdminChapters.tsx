...
const mapStatus: Record<string, string> = {
  ...
  `${API_URL}/chapters?page=${currentPage}&limit=6&search=${search}&hadManager=${hadManager}&status=${status}`,
...
if (isMounted && result.data) {
  ...
  }, [search, currentPage, hadManager, status, openAdd, openDetails]);
